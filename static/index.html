                        ...
                        <div class="alert alert-info alert-dismissable">
                                	<form action="/map" method="post">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon">Twitter Account</span> <input name="name" type="text" />
                                        </div>
                                        </td width="10%">
                                        <td>
                                        OR
                                        ...
                                        <td width="50%">
                                        <div class="input-group">
                                            <span class="input-group-addon">Text</span> <textarea name="tweet" rows="2" cols="50"></textarea>
                                        </div>
                                        </td>
                                        <td width="10%">                
